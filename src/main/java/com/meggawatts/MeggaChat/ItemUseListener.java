...
public class ItemUseListener implements Listener {
    ...
    //Blocks use of blacklisted items + removes them from hand!
    @EventHandler(priority = EventPriority.HIGH)
    public void onInteract(PlayerInteractEvent event) {
    	if ((event.getAction().equals(Action.RIGHT_CLICK_AIR)) || (event.getAction().equals(Action.RIGHT_CLICK_BLOCK)) && (event.hasItem())) {
